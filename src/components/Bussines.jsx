...
const FeatureCard =({icon, title, content,index}) =>(
  <div className={`flex flex-row p-6 rounded-[20px]
    ...
    <div className="flex-1 flex flex-col ml-3 ">
      <h4 className="font-poppins font-semibold  text-white text-[18px] mb-2 leading-[23px] ">{title}</h4>
      <p className="font-poppins font-normal leading-[24px] text-dimWhite text-[16px] mb-1  " >{content}</p>
    ...
    <section id="features" className={layout.section}>
      <div className={layout.sectionInfo}>
        ...
        you can improve your financial life by building credit,
         earning rewards and saing money. 
